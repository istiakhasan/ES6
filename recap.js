...
3.arrow function
3.a:with one parameter. will return the number after divideng by 5
3.b:with two parameters. will add two to each number and then multyply the result
...
7.[challengint] array of objects (e.g products).use find to get the object with price 500
8.you have an object . Now use destruction to create a simple variable of any property of the object
...
this function will take three parameters and will return the sum of all the three paramters
